...
public class NetworkTransmitter : NetworkBehaviour {
    ...
    private const int REALIABLE_SEQUENCED_CHANNEL = (int)QosType.ReliableSequenced; //changed
    ...
    private class TransmissionData {
        ...
        public TransmissionData(byte[] data_) {
            curDataIndex = 0;
            data = data_;
        }
    }
    ...
    [ClientRpc(channel = REALIABLE_SEQUENCED_CHANNEL)]
