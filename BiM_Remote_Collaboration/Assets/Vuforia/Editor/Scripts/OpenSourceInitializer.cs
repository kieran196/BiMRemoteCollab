...
public static class OpenSourceInitializer
{
    ...
    class DefaultBehaviourAttacher : IDefaultBehaviourAttacher
    {
        ...
        void IDefaultBehaviourAttacher.AddDefaultTrackableBehaviour(GameObject go)
        {
            throw new System.NotImplementedException();
        }

        void IDefaultBehaviourAttacher.AddDefaultInitializationErrorHandler(GameObject go)
        {
            throw new System.NotImplementedException();
        }
